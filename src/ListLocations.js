  ...
  render(){
    return(
      <div id="list-locations" ref="list">
        ...
        <ul tabIndex={0} aria-live="assertive" aria-labelledby="restaurant-list" id="locations-list" className={this.state.check? "locations-list open": "locations-list close"}>
